...
'***'PUBLIC FUNCTIONS
	...
	'**************************************************************************
		...
		'	Dim objXMLHTTP : Set objXMLHTTP = Server.CreateObject("Msxml2.ServerXMLHTTP.3.0")  		' Local server *-*

			Dim objXMLHTTP : set objXMLHTTP = Server.CreateObject("WinHTTP.WinHTTPRequest.5.1")		' Carelink
			objXMLHTTP.SetProxy 2, "172.19.27.10:8080"    											' Carelink 
